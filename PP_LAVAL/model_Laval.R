...
# taucl=0, clear sky
lut <- read.table("PP_LAVAL/LAVAL_Ed0moins_LUT.dat")
...
# Water absorption
awtable <- read.table(file="PP_LAVAL/LAVAL_Absorption_Water.csv", sep=";")
...
awtable_Morel <- read.table(file="PP_LAVAL/LAVAL_Tableau_Water_Morel & Moriterano.csv", sep=";", header=T)
...
aphytable <- read.table(file="PP_LAVAL/LAVAL_Absorption_phyto.csv", sep=";") # Matsuoka et al. (2011)
