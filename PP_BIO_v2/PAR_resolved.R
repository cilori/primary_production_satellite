...
source("Gcmod.r")
source("Watt_to_quanta.R")

# here We download clear sky irradiane, it will be used to
# derive Ed(lambda,0-) as we sill scale the visibility to match
# model and satellite PAR, the variable is PARday
load("LUT_PAR_lati_day_vis.Rdata")
...
# computer sun angle for day 180
# Here we set information for a given pixel.
xhr = 1:23
latipxl = 50.
daypxl = 173
yearpxl = 2018
